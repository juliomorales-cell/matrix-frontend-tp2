...
🔗 **Link de Vercel:** (https://matrix-frontend-tp2-i5x1.vercel.app)
...
- **Rodrigo** - [GitHub](https://github.com/RodrigoZocco)
...
*(Agregar aquí las imágenes del proyecto en funcionamiento. Colocar los archivos en `public/screenshots/` y reemplazar las rutas de ejemplo.)*

![Dashboard Home]() ⚠️ PENDIENTE: reemplazar por la ruta real  
![Perfil Individual]() ⚠️ PENDIENTE  
![Explorador JSON]() ⚠️ PENDIENTE  
![Red Externa con paginación]() ⚠️ PENDIENTE  
![Galería con Lightbox]() ⚠️ PENDIENTE  
![Bitácora]() ⚠️ PENDIENTE  
![Árbol de Renderizado]() ⚠️ PENDIENTE  
